 ...
 */
class StaggerGridAdapter(private val beans: ArrayList<ImageBean>) : RecyclerView.Adapter<StaggerGridAdapter.StaggerGridViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StaggerGridViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.adapter_staggergrid, null, false)
